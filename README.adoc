...
As stated before we need a previous JSF call to store button id in *${btAjax}* variable, form id in *${form}* variable and *viewState* in *${viewState} variable in gatling session. Here is the *initial* call:
