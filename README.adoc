...
Here is an example of row select event from this showcase page (third table):http://www.primefaces.org/showcase/ui/data/datatable/selection.xhtml[http://www.primefaces.org/showcase/ui/data/datatable/selection.xhtml^]

First thing is save row id because its needed for row select event:
